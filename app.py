...
def index():
    ...
    return render_template('index.html', graphJSON=graphJSON, layoutJSON=layoutJSON, graphJSON2=graphJSON, layoutJSON2=layoutJSON, graphJSON3=graphJSON, layoutJSON3=layoutJSON)
